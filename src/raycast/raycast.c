...
{
	return (mlx_load_png(game->map.no_xpm)); // Color for the west wall
}

mlx_texture_t *get_east_wall_color(t_game *game) {
	return (mlx_load_png(game->map.no_xpm)); // Color for the east wall
}

mlx_texture_t *get_south_wall_color(t_game *game) {
	return (mlx_load_png(game->map.so_xpm)); // Color for the south wall
}

mlx_texture_t *get_north_wall_color(t_game *game) {
	return (mlx_load_png(game->map.so_xpm)); // Color for the north wall
}
